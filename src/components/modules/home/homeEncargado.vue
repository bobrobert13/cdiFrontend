     ...
     <div class="col-10 q-mt-md">
         ...
         <div class="col-12 q-mt-xs">
          ...
          <div class="row jusitify-center">
           <div class="col-6 q-pa-sm">
            <q-input filled color="deep-purple-6" v-model="dataUser.persona.nombre1" @blur="validateDoctorInfoInputs"
             label="Nombre completo" :rules="[
           ...
           <div class="col-6 q-pa-sm">
            <q-input filled color="deep-purple-6" v-model="dataUser.numero_carnet" @blur="validateDoctorInfoInputs"
             label="Número de carnet" :rules="[
              (val) => !!val || 'Este campo es obligatorio',
              (val) => /^[a-zA-Z0-9]+$/.test(val) || 'Solo se permiten letras y números (sin espacios ni símbolos)'
             ]" />
           </div>
           <div class="col-6 q-pa-sm">
            <q-input filled color="deep-purple-6" v-model="dataUser.anos_experiencia" @blur="validateDoctorInfoInputs"
             label="Años de experiencia" :rules="[
              (val) => !!val || 'Este campo es obligatorio',
              (val) => /^\d+$/.test(val) || 'Solo se permiten números',
           ...
           <div class="col-6 q-pa-sm">
            <q-input filled color="deep-purple-6" v-model="dataUser.area_de_trabajo" @blur="validateDoctorInfoInputs"
             label="Area de trabajo" :rules="[
              (val) => !!val || 'Este campo es obligatorio'
             ]" />
           </div>
           <div class="col-6 q-pa-sm">
            <q-select filled color="deep-purple-6" v-model="dataUser.horario" @blur="validateDoctorInfoInputs"
             label="Horario de trabajo" :rules="[
              (val) => !!val || 'Este campo es obligatorio'
             ]" :options="[
           ...
           <div class="col-6 q-pa-sm">
            <q-input filled color="deep-purple-6" v-if="dataUser.persona.telefono"
             v-model="dataUser.persona.telefono.numero" @blur="validateDoctorInfoInputs" label="Teléfono" :rules="[
              (val) => !!val || 'Este campo es obligatorio',
              (val) => /^\d+$/.test(val) || 'Solo se permiten números',
           ...
           <div class="col-6 q-pa-sm">
            <q-input filled color="deep-purple-6" v-if="dataUser.persona.correo"
             v-model="dataUser.persona.correo.correo" @blur="validateDoctorInfoInputs" label="Email" :rules="[
              (val) => !!val || 'Este campo es obligatorio',
              (val) => /.+@.+\..+/.test(val) || 'Formato de correo electrónico inválido'
             ]" />
           </div>
           <q-btn unelevated :disabled="!isDoctorInfoValid" :loading="loader" @click="actualizarDoctor(dataUser)"
      ...
      <div class="row justify-between " v-if="viewType === 'addWorker'">
       <div class="col-12 text-left row items-center q-mt-md q-mb-md">
        <q-icon style="cursor: pointer" @click="workerView('userList')" name="mdi-arrow-left" class="text-primary"
         size="md"></q-icon>
        <span style="cursor: pointer" class="text-bold text-accent text-h6" @click="workerView('userList')">Nuevo
         doctor</span>
       </div>
       <div class="col-6">
