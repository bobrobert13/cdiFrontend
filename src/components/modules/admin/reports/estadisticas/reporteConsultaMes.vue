<template>
  <div class="pdf-container">
    ...
    <div class="text-center q-mb-md">
      ...
      <p class="text-grey-6 no-padding q-mt-sm">Total de consultas en el mes</p>
    </div>
    ...
    <div class="info-section" v-if="filasSemanas.length">
      <div class="section-title">Distribución Semanal</div>
...
export default {
  ...
  created() {
    console.log('reporteConsultaMes:', this.data);
  },
  computed: {
    filasSemanas() {
      ...
      return this.data.categorias.map((semana, idx) => {
        ...
        return { semana, consultas: valor, porcentaje };
      });
    }
  },
  methods: {
