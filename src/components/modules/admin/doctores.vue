	...
	<div class="row justify-center">
		...
		<div class="row justify-between" v-if="viewType === 'addWorker'">
			<div class=" col-12 text-left row items-center text-left q-mb-lg">
				<q-icon style="cursor: pointer" @click="workerView('userList')" name="mdi-arrow-left"
					class="text-primar q-mr-sxs" size="md"></q-icon>
			...
			<div class="col-6">
				<div class="column justify-center">
					...
					<q-select filled class="q-mb-xs" v-model="nacionalidad" :options="nacionalidades"
					...
					<div class="row q-mb-xs">
						...
						<div class="col-4">
							<q-input filled color="deep-purple-6" v-model="numero" label="Número de casa"
								type="number" />
						</div>
					</div>
					...
					<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 q-mb-xs">
						<div class="row">
							<div class="col-4">
								<q-select filled v-model="codigo" :options="codigoTel" label="Codigo"
									option-label="label" option-value="value" emit-value />
							</div>
							<div class="col-8">
			...
			<div class="col-6" style="border-left: 10px solid white;">
				<div class="column justify-center">
					...
					<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
						...
						<q-select filled color="deep-purple-6" class="q-mb-xs" v-model="cdiSeleccionado"
							label="Asignar al CDI" :options="cdisList" />
		...
		<div v-if="viewType === 'addWorker'" class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-xs-12 q-mb-xs ">
			<q-btn unelevated :loading="loader" @click="addDoctor()"
				:disable="!valid || !cdiSeleccionado || !cdiSeleccionado.value || fullName === '' || numero === '' || nacionalidad === '' || dni === '' || telefono === '' || email === '' || password === '' || doctor_nombre_usuario === '' || doctor_numero_carnet === '' || doctor_horario === '' || doctor_anos_experiencia === '' || roleEspecialidad === '' || role === '' || codigo_postal === '' || punto_referencia === '' || sector === '' || calle === '' || ciudad === '' || estado === ''"
