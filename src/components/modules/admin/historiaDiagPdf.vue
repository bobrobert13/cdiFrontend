<template>
  ...
  <div v-if="data.diagnosticos && data.diagnosticos.length > 0" class="info-section">
    ...
    <div v-else class="info-section">
      ...
      <div class="no-data">El paciente no posee diagnósticos registrados</div>
    </div>
...
export default {
  name: "historiaDiagPdf",
  components: {},
  props: ["data"],
	mounted() {
		console.log('Data recibida en historiaDiagPdf:', this.data);
	},
  methods: {
    salidaFecha(salida) {
