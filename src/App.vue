...
<template>
	...
	>
		...
		>
			...
			>
				...
				>
					...
					>
						...
						>
							<div
								class="col-xl-5 col-lg-4 col-md-5 col-sm-8 col-xs-11 q-mb-xl q-mt-lg self-center text-center"
							>
								<q-img
									src="./assets/MEDRECLOGO.png"
									style="
										width: 50%;
									"
								></q-img>
			...
			>
				<div
					class="row full-width justify-evenly items-center"
				>
					<div
						class="col-1"
					>
			...
			>
				...
				>
					...
					>
						...
						>
							...
							<div
								class="col-xl-8 column col-lg-8 col-md-8 col-sm-12 col-xs-12"
								v-if="
									this
										.user
										.role !==
							...
							>
								<q-btn
									...
									@click="
										actualizarUsuario(
											userCDIProfile.usuarios
										)
									"
									class="fullwidth text-white q-mt-xs bg-primary"
									label="Modificar credenciales"
									:disable="
										!isValidCredencialesCDI
									"
								/>
							</div>
						</div>
				...
				>
					<q-btn
						color="primary"
						class="q-mb-sm"
						label="Establecer preguntas de seguridad"
						@click="
							seguridadModal = true
						"
					/>
					...
					<q-btn
						color="primary"
						class="q-mb-sm"
						label="Establecer seguridad de PIN"
						@click="
							pinModal = true
						"
					/>
		...
		>
			...
			>
				<span
					class="text-center q-my-sm text-bold"
					>Es
					conveniente
					activar
					las
						...
						>
							<q-input
								...
								v-model="
									pin
								"
								label="Establece el PIN de seguridad (min 4 dígitos - max 6 dígitos)"
								type="password"
							/>
						</div>
...
import {
	ADD_PREGUNTAS_RECUPERACION,
	ADD_PIN_RECUPERACION,
	GET_SEGURIDAD_RECUPERACION,
} from "./graphql/seguridad.js";
							...
							this.$q.notify(
								{
									...
									icon: "mdi-check",
									message:
										"Pin de seguridad actualizada correctamente",
								}
							);
						}
					)
			...
			validateDoctorCredentialsInputs() {
				...
				const nameValid =
					this
						...
						.length >=
					3;
				this.isValidCredencialesDoctor =
					passwordValid &&
					nameValid;
			},
			validateUserCredentialsInputs() {
